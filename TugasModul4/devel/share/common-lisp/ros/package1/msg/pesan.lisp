...
(cl:defmethod cl:initialize-instance :after ((m <pesan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pesan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package1-msg:<pesan> is deprecated: use package1-msg:pesan instead.")))

(cl:ensure-generic-function 'usia-val :lambda-list '(m))
(cl:defmethod usia-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:usia-val is deprecated.  Use package1-msg:usia instead.")
  (usia m))

(cl:ensure-generic-function 'tinggi-val :lambda-list '(m))
(cl:defmethod tinggi-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:tinggi-val is deprecated.  Use package1-msg:tinggi instead.")
  (tinggi m))

(cl:ensure-generic-function 'nama-val :lambda-list '(m))
(cl:defmethod nama-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:nama-val is deprecated.  Use package1-msg:nama instead.")
  (nama m))

(cl:ensure-generic-function 'kehadiran-val :lambda-list '(m))
(cl:defmethod kehadiran-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package1-msg:kehadiran-val is deprecated.  Use package1-msg:kehadiran instead.")
  (kehadiran m))
