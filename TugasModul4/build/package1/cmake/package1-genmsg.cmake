...
set(MSG_I_FLAGS "-Ipackage1:/home/karol/TPD_4/src/package1/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/karol/TPD_4/src/package1/msg/pesan.msg" NAME_WE)
add_custom_target(_package1_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "package1" "/home/karol/TPD_4/src/package1/msg/pesan.msg" ""
)

get_filename_component(_filename "/home/karol/TPD_4/src/package1/srv/magnitude.srv" NAME_WE)
add_custom_target(_package1_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "package1" "/home/karol/TPD_4/src/package1/srv/magnitude.srv" ""
)
...
_generate_msg_cpp(package1
  "/home/karol/TPD_4/src/package1/msg/pesan.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(package1
  "/home/karol/TPD_4/src/package1/srv/magnitude.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/package1
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package1)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/package1\")")
  # install generated code
  install(
